    ...
    <div class="container mb-5">
        ...
        <form method="POST" action="{{route("addConductorShiftPost")}}">
            ...
            <div class="row mb-4 justify-content-center">
                ...
                <div class="col-5"><span class="text-danger text-sm-right">@error('dateEnd'){{$message}}@enderror</span>
                </div>
                <div class="w-100 pb-4"></div>
            </div>
            <!--Recette-->
            <div class="row justify-content-center">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="w-100"></div>
                    <div class="col-4"><span class="text-danger text-sm-right">@error('startingMillage'){{$message}}@enderror</span>
                    </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="w-100"></div>
                    <div class="col"><span class="text-danger text-sm-right">@error('startingMileageLaden'){{$message}}@enderror</span>
                    </div>
                    <div class="col"><span class="text-danger text-sm-right">@error('endingMileageLaden'){{$message}}@enderror</span>
                    </div>
                    <div class="col-3"></div>
                    <div class="w-100 pb-4"></div>
                </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="w-100"></div>
                    <div class="col"><span class="text-danger text-sm-right">@error('startingAmountOfPassengers'){{$message}}@enderror</span>
                    </div>
                    <div class="col"><span class="text-danger text-sm-right">@error('endingAmountOrPassengers'){{$message}}@enderror</span>
                    </div>
                    <div class="col-3"></div>
                    <div class="w-100 pb-4"></div>
                </div>
                ...
                <!--dépense autre : gaz, credit, divers-->
                <div class="row justify-content-center">
                    <div class="col input-group">
                ...
                <div class="row justify-content-center">
                    <div class="col input-group">
                        ...
                        <input id="totalExpenses" class="form-control font-weight-bold bg-transparent border-0"
