...
<div id="navigation-bar" class="container-fluid mb-3 navbar-light bg-light" style="padding:0">
    <nav class="navbar navbar-dark navbar-expand-lg bg-dark" id="mainNav">
        <div class="container"><a class="navbar-brand" href="{{route('home')}}">7-Taxi</a>
                ...
                <ul class="nav navbar-nav ml-auto text-uppercase">
                    @guest
                        ...
                        @if (Route::has('register'))
                            <li class="nav-item" role="presentation"><a class="nav-link js-scroll-trigger" href="{{route('register')}}">Instription</a></li>
    ...
    <div id="navbarSupportedContent" class="collapse navbar-collapse">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item dropdown font-weight-bold">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
                   aria-haspopup="true" aria-expanded="false">Formulaires de chauffeur</a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="{{route('addConductorShift')}}">Ajout de shift</a>
                    <a class="dropdown-item" href="{{route('createConductor')}}">Création de chauffeur</a>
                </div>
            ...
            <li class="nav-item dropdown font-weight-bold">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <form method="post">
                        ...
                        <button type="submit" class="dropdown-item" value="conductor" formaction="{{route('modifyConductorRequest')}}">Modification de chauffeur
                        </button>
                        <button type="submit" class="dropdown-item" value="client" formaction="{{route('modifyClientRequest')}}">Modification de client
                        </button>
                        <button type="submit" class="dropdown-item" value="taxi" formaction="{{route('modifyTaxiRequest')}}">Modification de taxi
                        </button>
                        <button type="submit" class="dropdown-item" value="fixTarif" formaction="{{route('modifyFixTarifRequest')}}">Modification de tarif fix
                        </button>
                    </form>
                </div>
            </li>
        ...
        <ul class="navbar-nav ml-auto">
            @guest
                <li class="nav-item font-weight-bold ml-auto"><a class="nav-link"
                ...
                @endif
            @else
                <li class="nav-item font-weight-bold ml-auto"><a class="nav-link" href="{{route('logout')}}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Déconnexion</a>
                </li>
                <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">@csrf</form>
            @endguest
        </ul>
